  ...
  return (
    <footer>
        <div className="col first-col">
            <h2>Vishal Bharti Sr. Sec. School</h2>
        ...
        <div className="col fourth-col">
            ...
            <div className="icons">
                <NavLink to='/' style={{ color: '#fff' }}><FaFacebook /></NavLink>
                <NavLink to='/' style={{ color: '#fff' }}><FaYoutube /></NavLink>
                <NavLink to='/' style={{ color: '#fff' }}><FaInstagram /></NavLink>
                <NavLink to='/' style={{ color: '#fff' }}><FaTwitter /></NavLink>
            </div>
        </div>
    </footer>
  )
